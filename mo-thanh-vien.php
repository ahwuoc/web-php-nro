        ...
        <div class="col-lg-6 offset-lg-3">
            ...
            if (isset($_POST['submit'])) {
                if ($_status == '1') {
                    ...
                    $_alert = '<div class="text-danger pb-2 font-weight-bold">Bạn không đủ 10.000 VND. Vui lòng nạp thêm tiền vào tài khoản để ' . ($_status == '0' ? 'kích hoạt nhé!' : 'mở lại tài khoản!</div>');
                } elseif (($_status == '0' || $_status == '-1') && $_coin >= 10000) {
                    if ($_tcoin >= 10000) {
                        $coin = $_coin - 10000;
            ...
            <form id="form" method="POST">
                ...
                <?php if ($_status == '0' || $_status == '-1'): ?>
                    ...
                    <?php else: ?>
                        <div class="text-danger pb-2 font-weight-bold">Bạn không đủ 10.000 VND để mở thành viên!</div>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if ($_status == 1): ?>
