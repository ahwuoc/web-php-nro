    ...
    if ($isLinked) {
        ...
        if ($remainingMinutes <= 0) {
            ...
            try {
                ...
                $mail->setFrom('ngocrong@gmail.com', 'Ngọc Rồng Múp'); // Change to your email and name
                $mail->addAddress($primaryGmail);
                $mail->Subject = '=?UTF-8?B?' . base64_encode('Xác nhận xóa liên kết Email - Ngọc Rồng Múp') . '?=';
