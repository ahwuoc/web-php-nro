                            ...
                            <div id="data_news">
                                    ...
                                    <div class="ant-list-item-meta home_page_listItemTitle__YB3V5">
                                        <div class="ant-list-item-meta-content">
                                            <h4 class="ant-list-item-meta-title">
                                                <a href="/news/10.php">CƠ CHẾ SET KÍCH HOẠT</a>
                                            </h4>
                                            <div class="ant-list-item-meta-description">
                                                Đăng bởi: <b style="color: red;">ADMIN</b> - Ngày: 11/11/2025
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="ant-list-item home_page_listItem__GD_iE">
                                    ...
                                    <div class="ant-list-item-meta home_page_listItemTitle__YB3V5">
                                        <div class="ant-list-item-meta-content">
                                            <h4 class="ant-list-item-meta-title">
                                                <a href="/news/9.php">HƯỚNG DẪN MỞ THÀNH VIÊN</a>
                                            </h4>
                                            <div class="ant-list-item-meta-description">
                                                Đăng bởi: <b style="color: red;">ADMIN</b> - Ngày: 11/11/2025
                                            </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="javascript:void(0)">
                                        <img src="/image/traidat.png" alt=""
                                            class="img-fluid swiper-lazy w-100 loading_lazy" data-ignore="true">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="javascript:void(0)">
                                        <img src="/image/namec.png" alt=""
                                            class="img-fluid swiper-lazy w-100 loading_lazy" data-ignore="true">
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="javascript:void(0)">
                                        <img src="/image/xayda.png" alt=""
                                            class="img-fluid swiper-lazy w-100 loading_lazy" data-ignore="true">
                                    </a>
                                </div>
                            </div>
