                ...
                try {
                    ...
                    if ($storedGmail === $gmail) {
                        ...
                        try {
                            ...
                            $mail->SMTPAuth = true;
                            $mail->Username = 'hilo17012003@gmail.com'; // Thay đổi thành email của bạn
                            $mail->Password = 'quowqcmfwmpuduvp'; // Thay đổi thành mật khẩu của bạn
                            $mail->SMTPSecure = 'tls';
                            $mail->Port = 587;

                            // Thiết lập thông tin email
                            $mail->setFrom('hilo17012003@gmail.com', 'Ngọc Rồng Múp '); // Thay đổi thành email của bạn và tên của bạn
                            $mail->addAddress($gmail);
                            $mail->Subject = '=?UTF-8?B?' . base64_encode('Quên Mật Khẩu - Ngọc Rồng Múp ') . '?=';
                        ...
                        echo "<br>Không tìm thấy Gmail của người dùng với tài khoản: " . $username;
                    }
